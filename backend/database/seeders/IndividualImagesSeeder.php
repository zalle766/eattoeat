...
class IndividualImagesSeeder extends Seeder
{
    public function run(): void
    {
        // إنشاء مطعم جديد مع منتجات مختلفة الصور
        $restaurantOwner = User::create([
            'name' => 'مطعم الصور الفردية',
            'email' => 'individual@eattoeat.com',
            'password' => Hash::make('password'),
            'role' => 'restaurant',
            'phone' => '+1234567899',
            'address' => 'شارع الصور الفردية، الرباط، المغرب',
            'latitude' => 34.0209,
            'longitude' => -6.8416,
            'is_active' => true,
        ]);
        ...
        $restaurant = Restaurant::create([
            ...
            'name' => 'مطعم الصور الفردية',
            'description' => 'مطعم يقدم أطباق متنوعة مع صور فردية لكل منتج',
            'address' => 'شارع الصور الفردية، الرباط، المغرب',
            'latitude' => 34.0209,
            'longitude' => -6.8416,
            'phone' => '+1234567899',
            'email' => 'info@individual.com',
            'opening_time' => '09:00',
            'closing_time' => '23:00',
            'delivery_fee' => 15.00,
            'delivery_radius' => 10,
        ...
        // إنشاء منتجات مع صور مختلفة ومحددة
        $products = [
            [
            ...
            [
                ...
                'description' => 'بيتزا إيطالية أصيلة بالجبن والطماطم الطازجة',
                'price' => 200.00,
                'category' => 'بيتزا',
                'preparation_time' => 20,
            ...
            [
                ...
                'description' => 'سلطة طازجة ومتنوعة مع الصلصة الخاصة',
                'price' => 45.00,
                'category' => 'سلطات',
                'preparation_time' => 10,
            ...
            [
                'name' => 'سوشي طازج',
                'description' => 'سوشي طازج مع الأرز والأسماك الطازجة',
                'price' => 120.00,
        ...
        $this->command->info('Individual images seeded successfully!');
        $this->command->info('Restaurant with individual images: individual@eattoeat.com / password');
